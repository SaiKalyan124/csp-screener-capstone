...
- Golden fixtures reproduce ranking and contract-selection results.
- Every rejected symbol or contract has a machine-readable reason.
- Batched dashboard calls, cache behavior, latency, and freshness are measured.
- The API and MCP implementations pass the same provider contract tests.
